...
public class UserExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<CommonResponse> exception(IllegalArgumentException exception) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
              .body(CommonResponse.of(ErrorCode.INVALID_CODE, exception.getMessage()));
    }

    @ExceptionHandler
    public ResponseEntity<CommonResponse> exception(IllegalStateException exception) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
              .body(CommonResponse.of(ErrorCode.INVALID_CODE, exception.getMessage()));
    }

    @ExceptionHandler(MethodArgumentNotValidException.class)
    public ResponseEntity<CommonResponse> methodValidException(
    ...
    private CommonResponse makeErrorResponse(BindingResult bindingResult){
        String detail = "";
        ...
        return CommonResponse.of(ErrorCode.INVALID_CODE, detail);
    }
}
